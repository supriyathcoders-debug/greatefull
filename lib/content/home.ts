...
export const STATS = {
  items: [
    ...
    { number: "®", label: "Grateful Marketing®️ registered trademark" },
  ],
} as const;
...
export const GRATITUDE = {
  ...
  personalStory:
    "Andrea's embrace of AI didn't come from a boardroom. It came from necessity. After surviving two motor vehicle accidents that forced her to rebuild from the ground up, she discovered that the combination of human resilience and smart technology wasn't just possible — it was the only way forward. That's the origin of Grateful Marketing®️: not a clever business idea, but a lived philosophy. If she could rebuild her own life with gratitude as the compass, she could help organizations do the same.",
} as const;
...
export const WHY_GM = {
  eyebrow: "Why Grateful Marketing®️",
...
export const ABOUT = {
  eyebrow: "About Grateful Marketing®️",
  heading: "Where genuine purpose meets",
  headingEm: "cutting-edge technology.",
  paragraphs: [
    "Grateful Marketing®️ is a digital marketing consultancy founded by Andrea, a 25+ year marketing and AI strategist, helping organizations to apply AI to drive innovation, efficiency and growth.",
  ...
  expertBio:
    "Andrea is the Founder and CEO of Grateful Marketing®️ - A Strategist and Internationally Recognized AI Business Consultant, with 25+ years of experience, across technology, business consulting, and digital marketing.",
  expertEnterprise:
