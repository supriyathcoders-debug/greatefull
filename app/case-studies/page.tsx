        ...
        <div className="mx-auto w-full max-w-[1200px] px-6 pb-12 pt-14 md:pt-20">
          ...
          <div className="max-w-4xl mt-12 text-muted">
            ...
            <p className="mb-8 text-lg">
              The case studies below are organized around the four disciplines that define how Grateful Marketing®️ delivers for clients:
              hands-on digital marketing management, end-to-end marketing management, disciplined project management, and — increasingly
              — AI strategy and deployment. Each engagement draws on real client work, including work delivered prior to founding Grateful Marketing®️.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-4">
              ...
              <div className="card-glass p-6">
                ...
                <p className="text-sm">From early AI-assisted production workflows in enterprise consulting to a fully built AI team and methodology at Grateful Marketing®️ today, using AI daily for research, content development, and campaign analysis, and training client teams to do the same.</p>
              </div>
            </div>
          </div>
        </div>
