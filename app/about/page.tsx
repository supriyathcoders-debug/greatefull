...
export const metadata: Metadata = {
  title: "About",
  description: "Meet Andrea and the mission behind Grateful Marketing®️.",
};
  ...
  return (
    <div>
      ...
      <Section
        ...
        description="Andrea Gureckas founded Grateful Marketing®️ after seeing the same pattern across service businesses: strong demand, but inconsistent lead follow-up and lost sales opportunities. She built a premium AI automation agency to solve the conversion bottlenecks that silently drain revenue."
      />
