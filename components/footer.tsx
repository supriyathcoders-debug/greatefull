    ...
    <footer className="bg-background px-[6vw] pt-20 pb-10 border-t border-brand/10 mt-16 relative section-noise">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2.2fr_1fr_1fr_1fr] gap-12 pb-14 border-b border-border mb-10 relative z-10">
        ...
        <div>
          ...
          <ul className="list-none space-y-2.5">
            <li><Link href="/#about" className="text-[0.79rem] text-muted no-underline font-light transition-colors hover:text-brand">About Us</Link></li>
            <li><Link href="/#services" className="text-[0.79rem] text-muted no-underline font-light transition-colors hover:text-brand">Our Services</Link></li>
            <li><Link href="/#industries" className="text-[0.79rem] text-muted no-underline font-light transition-colors hover:text-brand">Industries We Serve</Link></li>
            <li><Link href="/case-studies" className="text-[0.79rem] text-muted no-underline font-light transition-colors hover:text-brand">Our Case Studies</Link></li>
            ...
            <li><Link href="/contact" className="text-[0.79rem] text-muted no-underline font-light transition-colors hover:text-brand">Contact Us Today</Link></li>
          </ul>
        </div>
